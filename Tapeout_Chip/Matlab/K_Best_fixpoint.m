function K_Best_fixpoint(Num_cc,Num_ii,Nt, Nr, N, SNR_DB, SNR, symbol_set, symbol_pattern, EE, M, m, Constellation_Mapping_Table, L, K)
%6bit，前3，後5 +sign bit，共9 bits
power = 5;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            %%%%%QR_decomposition%%%%%%%%%%%%%%%%%%%%%%%%%%%
            [arg_rr,SS] = cordic_QR_new_fixpoint(HH,3,SS,constant);%2Nr*(2Nt+1)[yy_hat,R] = CORDIC_bin(yy, HH_k,6)
