...
module path1 (
	...
	input unsigned_logic R18xs[3:0],
	input sign_R78,
	input sign_R68,
	input sign_R58,
	input sign_R48,
	...
	signed_logic ydot3;
	adder_14bit y_R1828s(Rs5,Rs6,ydot3);
	...
	signed_logic ydot4;
	sub_14bit y_R38s(ydot_q,ydot1_q,ydot4);
	
	signed_logic ydot5;
	adder_14bit y_R1848s(ydot2_q,ydot3_q,ydot5);
	//--------pipe----------------
	...
	//--------------------------------
	signed_logic ydot6;
	sub_14bit y_R18s(ydot4_q,ydot5_q,ydot6);
	
	//--------pipe----------------
	signed_logic ydot6_q;
