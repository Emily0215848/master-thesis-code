...
module Layer5(
	...
	input [3:0] us1[2:0],us2[2:0],
	input unsigned_logic uPED1,uPED2,
	
	output logic [3:0] s1[3:0],s2[3:0],
	...
	logic sign_R2 [1:0];
	logic sign_R3 [1:0];
	logic [3:0] us1_q1 [1:0][2:0];
	logic [3:0] us2_q1 [1:0][2:0];
	...
	always_ff@(posedge clk)begin
		if(rst)begin
			...
			y_q[0] <= y;
			y_q[1] <= y_q[0];
			sign_R1[0] <= R5[1][`sign_bit];
			sign_R1[1] <= sign_R1[0];
			sign_R2[0] <= R5[2][`sign_bit];
			sign_R2[1] <= sign_R2[0];
			sign_R3[0] <= R5[3][`sign_bit];
			sign_R3[1] <= sign_R3[0];
			us1_q1[0] <= us1;
			us2_q1[0] <= us2;
			us1_q1[1] <= us1_q1[0];
	...
	//
	//-----------pipe----------------
	logic [3:0] us1_q[4:0][2:0];
	logic [3:0] us2_q[4:0][2:0];
	always_ff@(posedge clk)begin
		if(rst)begin
